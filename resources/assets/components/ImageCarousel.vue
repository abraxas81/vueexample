<template>
    <div class="image-carousel"><img :src="image"/>
        <div class="controls">
...
<script>
    export default {
        ...
        methods: { changeImage(val) { let
            newVal = this.index + parseInt(val); if (newVal < 0) { this.index =
            this.images.length -1; } else if (newVal === this.images.length) { this.index = 0;
        } else { this.index = newVal; } } },
